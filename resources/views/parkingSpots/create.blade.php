<x-layout>
    <div class="max-w-2xl mx-auto">
        <div class="mb-8">
            ...
            <h2 class="text-2xl font-bold tracking-tight">Create Parking Spot</h2>
            <p class="text-zinc-400">Add a new parking spot to the system.</p>
        </div>

        <div class="bg-zinc-900 border border-zinc-800 rounded-lg p-6">
            <form method="POST" action="{{ route('parkingSpots.store') }}" class="space-y-6">
                @csrf
                ...
                <div>
                    ...
                    <input id="spot_number" type="text" name="spot_number" value="{{ old('spot_number') }}" required
                        class="w-full bg-black border border-zinc-800 rounded-md py-2 px-3 text-white focus:outline-none focus:border-white focus:ring-1 focus:ring-white transition-colors">
                ...
                <div>
                    ...
                    <select id="type" name="type" required
                        ...
                        <option value="handicap" {{ old('type') == 'handicap' ? 'selected' : '' }}>Handicap</option>
                    </select>
                ...
                <div>
                    <label for="is_active" class="inline-flex items-center">
                        <input id="is_active" type="checkbox" name="is_active" value="1" {{ old('is_active', true) ? 'checked' : '' }} class="rounded bg-zinc-900 border-zinc-700 text-white focus:ring-white">
